function sqq_tt_bbeevv(iq, jf, p1, p2, p3, p4, p5, p6, p7, p8)
...
function qq_tt_bbeevv(iq, jf, p1, p2, p3, p4, p5, p6, p7, p8, nhel)
  ...
  if (interference == 0) then
    ...
    qq_tt_bbeevv = qq_tt_bbeevv + amp_tmp*conjg(amp_tmp)
    do i = 3, ngraphs
      qq_tt_bbeevv = qq_tt_bbeevv + amp(i)*conjg(amp(i))
    end do
