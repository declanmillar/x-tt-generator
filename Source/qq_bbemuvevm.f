...
function qq_bbemuvevm(p1, p2, p3, p4, p5, p6, p7, p8,nhel)
    ...
    parameter (ngraphs= 44,neigen=  1,nexternal=8)
    real*8 ::     zero
    parameter (zero=0d0)
    ...
    call fsoxxx(w6  ,w34 ,gh(1,5  ),fmass(5  ),fwidth(5  ),w39 )
    ...
    call fsoxxx(w6  ,w49 ,gh(1,5  ),fmass(5  ),fwidth(5  ),w54 )
