      real*8 function sqqbbffff_qcd(iq, p1, p2, 
     &                               p3, p4, p5, p6, p7, p8)
c  
...
c          endif
      ...
      if(sqqbbffff_qcd.eq.0.d0)return 
      do i=-1,+1,2
        do j=-1,+1,2
...
c     & polqq(-1,-1)+polqq(-1,+1)+polqq(+1,-1)+polqq(+1,+1)
      ...
      real*8 function qqbbffff_qcd(iq,p1, p2, 
...
c ----------
      ...
      do i = 1, neigen
          ...
          enddo
          qqbbffff_qcd =qqbbffff_qcd+ztemp*eigen_val(i)*conjg(ztemp) 
      enddo
