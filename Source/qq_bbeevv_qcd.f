function sqq_bbeevv_qcd(p1, p2, p3, p4, p5, p6, p7, p8)
    ...
    do ihel=1,ncomb
        if (goodhel(ihel) .or. ntry < 10) then
            t=qq_bbeevv_qcd(p1, p2, p3, p4, p5, p6, p7, p8,nhel(1,ihel))
            sqq_bbeevv_qcd = sqq_bbeevv_qcd + t
    ...
    enddo
    sqq_bbeevv_qcd = sqq_bbeevv_qcd /  4d0
end function sqq_bbeevv_qcd


function qq_bbeevv_qcd(p1, p2, p3, p4, p5, p6, p7, p8,nhel)
    ...
    do i = 1, neigen
        ...
        enddo
        qq_bbeevv_qcd =qq_bbeevv_qcd+ztemp*eigen_val(i)*conjg(ztemp)
    enddo
    !      call gaugecheck(amp,ztemp,eigen_vec,eigen_val,ngraphs,neigen)
end function qq_bbeevv_qcd
