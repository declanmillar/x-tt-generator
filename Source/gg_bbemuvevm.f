...
function gg_bbemuvevm(p1, p2, p3, p4, p5, p6, p7, p8,nhel)
    ...
    parameter (ngraphs=103,neigen=  2,nexternal=8)
    real*8 ::     zero
    parameter (zero=0d0)
    ...
    call ixxxxx(p5  ,fmass(5  ),nhel(5  ),-1,w5  )
    call oxxxxx(p6  ,fmass(1  ),nhel(6  ), 1,w6  )
    call ixxxxx(p7  ,fmass(2  ),nhel(7  ),-1,w7  )
    call oxxxxx(p8  ,fmass(6  ),nhel(8  ), 1,w8  )
    ...
    call fsixxx(w5  ,w34 ,gh(1,5  ),fmass(5  ),fwidth(5  ),w39 )
    ...
    call fsixxx(w5  ,w48 ,gh(1,5  ),fmass(5  ),fwidth(5  ),w53 )
    ...
    call fsixxx(w5  ,w73 ,gh(1,5  ),fmass(5  ),fwidth(5  ),w78 )
    ...
    call fsixxx(w5  ,w87 ,gh(1,5  ),fmass(5  ),fwidth(5  ),w92 )
    ...
    call fsixxx(w5  ,w102,gh(1,5  ),fmass(5  ),fwidth(5  ),w107)
    ...
    call fsixxx(w5  ,w117,gh(1,5  ),fmass(5  ),fwidth(5  ),w122)
