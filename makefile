...
HOST := $(shell hostname)
ifeq ($(OS),Linux)
	LFLAGS = -L/afs/cern.ch/user/d/demillar/zprime-top-generator/Library -lRootTuple -L/afs/cern.ch/sw/lcg/app/releases/ROOT/6.06.08/x86_64-slc6-gcc49-opt/root/lib $(ROOTLIBS)
endif
ifeq ($(HOST),cyan03)
