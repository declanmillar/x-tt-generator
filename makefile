...
# object files
OBJ = rambo.o vegas.o cteq61pdf.o mathematics.o configuration.o modelling.o scattering.o kinematics.o alpha_EWNG.o helas.o ggbbffff_qcd.o ggff_qcd.o mrs99.o qqbbffff_ewp.o qqbbffff_qcd.o qqff_ewp.o qqff_qcd.o rangen.o zprime.o dsigma.o
