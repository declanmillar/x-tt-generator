...
ifeq ($(UNAME_S),Linux)
	...
	LFLAGS = -L/afs/cern.ch/user/d/demillar/.RootTuple -lRootTuple -L/afs/cern.ch/sw/lcg/app/releases/ROOT/6.06.06/x86_64-slc6-gcc49-opt/root/lib -lGui -lCore -lCint -lRIO -lNet -lHist -lGraf -lGraf3d -lGpad -lTree -lRint -lPostscript -lMatrix -lPhysics -lMathCore -lThread -pthread -lm -ldl -rdynamic -lTreePlayer
endif
