c ================================= widthZp.f ==================================
c Authors: stefano moretti and declan millar
c d.millar@soton.ac.uk
c
c Calulates the width of the Zp in the SSM.
c ================================= widthZp ====================================
...
c u-quark. 
          t3q=+1.d0/2.d0 
          eq=+2.d0/3.d0 
        else if((i.eq.1).or.(i.eq.3).or.(i.eq.5))then 
c d-quark. 
          t3q=-1.d0/2.d0 
          eq=-1.d0/3.d0 
        end if 
        if(rmZp.le.2.d0*rmq)goto 123
