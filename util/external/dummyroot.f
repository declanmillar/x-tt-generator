...
C-----------------------------------------------------------------------
      ...
      subroutine rootaddprocessdouble(val,branch)
      double precision val
      character*30 branch
      end

      subroutine rootaddprocessfloat(val,branch)
      real val
      character*30 branch
      end

      subroutine rootaddprocessint(val,branch)
      integer val
      character*30 branch
      end

      subroutine rootaddprocessbool(val,branch)
      logical val
      character*30 branch
      end
