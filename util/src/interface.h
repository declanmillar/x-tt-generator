...
extern "C" {
    ...
    void FortranCInterface_GLOBAL(rootaddprocessdouble,ROOTADDPROCESSDOUBLE)(double *ptr, const char *branchname, int lbranchname)
    {rootaddprocessdouble(ptr, branchname, lbranchname);};
    void FortranCInterface_GLOBAL(rootaddprocessfloat,ROOTADDPROCESSFLOAT)(float *ptr, const char *branchname, int lbranchname)
    {rootaddprocessfloat(ptr, branchname, lbranchname);};
    void FortranCInterface_GLOBAL(rootaddprocessint,ROOTADDPROCESSINT)(int *ptr, const char *branchname, int lbranchname)
    {rootaddprocessint(ptr, branchname, lbranchname);};
    void FortranCInterface_GLOBAL(rootaddprocessbool,ROOTADDPROCESSBOOL)(bool *ptr, const char *branchname, int lbranchname)
    {rootaddprocessbool(ptr, branchname, lbranchname);};
#ifdef __cplusplus
}
#endif
