...
int main(int argc, char* argv[])
{
  ...
  TApplication* RootApp = new TApplication("RootApp",&argc,argv);
   ...
   //  RootApp->Run(kTRUE);
    ...
    // TCanvas* c_AllC = superpose(false,  "AllC", model, outputFileName, 
    //                                  "AllC", model2, outputFileName2);
    //                                  // "AllC", model3, outputFileName3,
    //                                  // "AllC", model4, outputFileName4);
    // c_AllC->Draw();
    // RootApp->Run(kTRUE);

    // TCanvas* c_AttC = superpose(false, "AttC", model, outputFileName, 
    ...
    // TCanvas* c_AFBstarNuReco = superpose(false, "AFBstarNuReco", model, outputFileName, 
  ...
  if (channel == "2to6") {
    ...
    TCanvas* c_PzNu = superpose(false, "PzNu", model, outputFileName, 
                          "PzNuReco", model, outputFileName);
		c_PzNu->Draw();
		RootApp->Run(kTRUE);

		TCanvas* c_MttPzNuReco = superpose(false, "Mtt", "SM", outputFileName, 
