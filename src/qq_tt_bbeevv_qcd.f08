function sqq_tt_bbeevv_qcd(iq, p1, p2, p3, p4, p5, p6, p7, p8)
...
function qq_tt_bbeevv_qcd(iq, p1, p2, p3, p4, p5, p6, p7, p8, nhel)
  ...
  qq_tt_bbeevv_qcd = 0.d0
  do i = 1, neigen
    ztemp = (0.d0, 0.d0)
    do j = 1, ngraphs
      ztemp = ztemp + eigen_vec(j,i)*amp(j)
    enddo
    qq_tt_bbeevv_qcd = qq_tt_bbeevv_qcd + ztemp*eigen_val(i)*conjg(ztemp)
  enddo
  ! call gaugecheck(amp, ztemp, eigen_vec, eigen_val, ngraphs, neigen)
end function qq_tt_bbeevv_qcd
