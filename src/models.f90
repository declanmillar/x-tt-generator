...
contains
  ...
  subroutine initialise_model
    ...
    if (verbose) print *, "models: initialising model ..."
  ...
  subroutine initialise_standard_model
    ...
    if (verbose) print *, "models: initialising standard model ..."
  ...
  subroutine initialise_zprimes
    ...
    if (verbose) print *, "models: initialising Z' parameters ..."
  ...
  subroutine reset_zprimes
    ...
    if (verbose) print *, "models: resetting Z' parameters"
  ...
  subroutine initialise_non_universal
    ...
    if (verbose) print *, "models: initialising non-universal model ..."
  ...
  subroutine convert_zprime_couplings
    ...
    if (verbose) print *, "models: converting couplings ..."
    do i = 1, 5
  ...
  subroutine width_zprimes
    ...
    if (verbose) print *, "models: calculating Z' -> ff widths ..."
    ...
    do n = 1, 5
      ...
      if (manual_width(n) == 0) then
        ...
        if (z_mixing == 1) then
          if (verbose) print *, "models: calculating Z' mixing ..."
          ...
          fzh = -gz*mx/zmass*ctmix*stmix/(ctmix*ctmix + mx*mx/zmass/zmass*stmix*stmix)**1.5
    ...
    if (verbose) print *, "models: calculated Z' -> ff widths"
  ...
  subroutine print_model
    ...
    if (verbose) print *, "models: printing model parameters ..."
