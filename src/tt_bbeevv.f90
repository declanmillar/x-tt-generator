...
function gg_tt_bbeevv(p1, p2, p3, p4, p5, p6, p7, p8, nhel, channel)
    ...
    do i = 1, neigen
        ...
        enddo
        gg_tt_bbeevv = gg_tt_bbeevv + atmp * eigen_val(i) * conjg(atmp)
    enddo
...
function sqq_tt_bbeevv_ew(iq, jf, p1, p2, p3, p4, p5, p6, p7, p8)
  ...
  enddo
  sqq_tt_bbeevv_ew = sqq_tt_bbeevv_ew/4d0
end function sqq_tt_bbeevv_ew


function qq_tt_bbeevv_ew(iq, jf, p1, p2, p3, p4, p5, p6, p7, p8, nhel)
  ...
  qq_tt_bbeevv_ew = 0.d0
  amp_tmp = (0.d0, 0.d0)
  amp_tmp2 = (0.d0, 0.d0)

  if (interference == 0) then
    do i = 1, ngraphs
      qq_tt_bbeevv_ew = qq_tt_bbeevv_ew + amp(i)*conjg(amp(i))
    end do
    ...
    qq_tt_bbeevv_ew = qq_tt_bbeevv_ew + amp_tmp*conjg(amp_tmp)
    do i = 3, ngraphs
      qq_tt_bbeevv_ew = qq_tt_bbeevv_ew + amp(i)*conjg(amp(i))
    end do
    ...
    qq_tt_bbeevv_ew = qq_tt_bbeevv_ew + amp_tmp*conjg(amp_tmp) - amp_tmp2*conjg(amp_tmp2)
