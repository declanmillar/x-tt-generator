...
module vamp_kinds
    ...
    ! integer, parameter, private :: single = selected_real_kind (precision(1.0))
    ! integer, parameter, private :: double = selected_real_kind (2 * precision(1.0_single))
    ! integer, parameter, private :: extended = selected_real_kind (2 * precision (1.0_double))
    ! integer, parameter, public :: default = double
